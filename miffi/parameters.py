...
CATAGORY_DEFAULT = ['good','bad_single','bad_film','bad_minor_crystalline','bad_multiple']

CATAGORY_ALL = ['good','bad_single','bad_film','bad_drift','bad_minor_crystalline',
                'bad_major_crystalline','bad_contamination','bad_multiple']

CATAGORY_GOOD_PREDICTIONS = [[0,1],[0],[0],[0]]
